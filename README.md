...
2. `オーディオの詳細プロパティ` を開き、音声モニタリングで `モニターと出力` を選択
3. 他の音源とまとめて管理できるため便利
...
# 複数パラメーターの組み合わせ
https://tetchan-lab.github.io/controller-viewer/?controller=dualsense&device=054c:0ce6&debug
```
